...
//static NSUInteger const HOLAWallPostsTableViewMainSection = 0;

@interface HOLAWallPostsTableViewController ()

@property (nonatomic, strong) UIButton *noDataButton;

@end

@implementation HOLAWallPostsTableViewController
...
//    NSLog(@"%s - x:%f, y:%@ ", __PRETTY_FUNCTION__, noDataButtonFrame.origin.x,noDataButtonFrame.origin.y);
