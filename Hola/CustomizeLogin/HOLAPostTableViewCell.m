...
#import "HOLAPostTableViewCell.h"
...
@interface HOLAPostTableViewCell ()
{
    UIImageView *_backgroundImageView;
}

//@property (nonatomic, assign, readwrite) HOLAPostTableViewCellStyle postTableViewCellStyle;

@end

@implementation HOLAPostTableViewCell
